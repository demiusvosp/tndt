...
## [current] - ~весна~ 25 _хоть бы в этом году выпустить_
- **New features**
  - [tndt-196](http://tasks.demiusvosp.ru/p/tndt-196) - Redis
- **New small features**
  - [tndt-159](http://tasks.demiusvosp.ru/p/tndt-159) - [wiki] Таблицы
  - [tndt-173](http://tasks.demiusvosp.ru/p/tndt-173) - [wiki] Ссылка на проект
  - [tndt-182](http://tasks.demiusvosp.ru/p/tndt-182) - [wiki] Ссылка на документ в проекте не очевидна
- **Bugfixes**
  - [tndt-206](http://tasks.demiusvosp.ru/p/tndt-206) - Ссылки в changelog. []( - делает ссылку внешней
...
- **New feature** 
  ...
  - [tndt-28](http://tasks.demiusvosp.ru/p/tndt-28) - Улучшение дашборда. Не отображаем root, показываем скрытые, но доступные пользователю проекты, увеличиваем количество задач и документов.
- **Bugfixes**
